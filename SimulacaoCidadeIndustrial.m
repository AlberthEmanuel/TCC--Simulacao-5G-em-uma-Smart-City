...
% Inicializa matrizes para distância e ângulo do local central até cada site de célula, onde
% cada site tem 3 células
numCellSites = 19;
...
isd = 100; % Distância entre locais
...
% Crie sites de transmissores usando os parâmetros definidos acima, bem
% como os parâmetros de configuração definidos para Dense Urban-eMBB. 
% Definido os parâmetros do transmissor usando a Tabela 8-2 (b) do Relatório ITU-R M.[IMT-2020.EVAL]
